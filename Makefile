...
pkgdatadir = $(datadir)/Relief
pkgincludedir = $(includedir)/Relief
pkglibdir = $(libdir)/Relief
pkglibexecdir = $(libexecdir)/Relief
...
ACLOCAL = ${SHELL} /home/a/BrazilCoins/Relief/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/a/BrazilCoins/Relief/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/a/BrazilCoins/Relief/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/a/BrazilCoins/Relief/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = Relief-cli
BITCOIN_DAEMON_NAME = Reliefd
BITCOIN_GUI_NAME = Relief-qt
BITCOIN_TX_NAME = Relief-tx
...
COPYRIGHT_HOLDERS_FINAL = The Relief developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Relief
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/a/BrazilCoins/Relief/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = Relief
PACKAGE_STRING = Relief 0.1.0
PACKAGE_TARNAME = Relief
PACKAGE_URL = https://Relief.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/a/BrazilCoins/Relief
abs_srcdir = /home/a/BrazilCoins/Relief
abs_top_builddir = /home/a/BrazilCoins/Relief
abs_top_srcdir = /home/a/BrazilCoins/Relief
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/a/BrazilCoins/Relief/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/Relief.icns
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/Relief.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/Relief.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Relief-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/Resources/Relief.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Relief-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Relief-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Relief-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
