...
#define GENESIS_TIME 1513195290
...
{
    const char* pszTimestamp = "New York Times 16/Jan/11 After deadly mudslides in Brazil, concert turns to preparedness";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(GENESIS_TIME, 2318056229, GENESIS_DIFFICULTY, 1, 50 * COIN);
    	
        //MineGenesisBlock(genesis);
    	
    	consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000050c4fb4b7d0bab35e85f673b906c1e4fe45db3d95768dfb4aed1080ac21b"));
        assert(genesis.hashMerkleRoot == uint256S("0xe9e904a6ec5aa287a525f10e51a1a18e001f3a45913a10cd5088e5a20fb28d57"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(GENESIS_TIME, 44036215, GENESIS_DIFFICULTY, 1, 50 * COIN);
	    
        //MineGenesisBlock(genesis);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00001bd5a283d10e99e610c023d7c1ecec97d07e3985b6165f1f9485e06410ae"));
        assert(genesis.hashMerkleRoot == uint256S("0xe9e904a6ec5aa287a525f10e51a1a18e001f3a45913a10cd5088e5a20fb28d57"));
...
public:
	...
	genesis = CreateGenesisBlock(GENESIS_TIME, 916727648, GENESIS_DIFFICULTY, 1, 50 * COIN);
	
    //MineGenesisBlock(genesis);
 
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000053909b90608b75f51b2692fc9123b9348e9c31657c066d0598c744dac495"));
        assert(genesis.hashMerkleRoot == uint256S("0xe9e904a6ec5aa287a525f10e51a1a18e001f3a45913a10cd5088e5a20fb28d57"));
